...
import IncrementingNumber from "./incrementingNums";

const ChooseAccrete: React.FC = () => {
  return (
    <section className="md:px-28 md:p-32 p-10 flex flex-col md:flex-row gap-20">
      {/* Container for the numbers ----------*/}
      <div className="bg-gray-300 rounded-3xl w-full md:w-3/5 p-10 flex flex-col gap-5">
