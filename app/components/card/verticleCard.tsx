...
const VerticleCard: React.FC = () => {
  return (
    <section className="absoulte transform -translate-y-[41%] z-40 shadow-3xl w-[85%] mx-auto gap-6 md:gap-0 flex flex-col md:flex-row justify-around items-center md:p-16 p-8 rounded-3xl bg-gray-100">
