...
const IconCard: React.FC<IconCardProps> = ({ icon, text }) => {
  return (
    <div className="cursor-pointer w-[50%] md:w-[20%] p-8 md:p-10 rounded-2xl flex flex-col items-center justify-center transform hover:-translate-y-2 bg-gray-100 hover:bg-blue-400">
