  ...
  return (
    <>
      <div className="relative">
        <section className="bg-hero-bg bg-cover bg-center pb-0 pl-12 pr-12 md:pl-20 md:pr-20">
          <div className="flex flex-col md:flex-row md:items-center justify-between pt-20 px-4 md:px-12">
            <div className="text-textColor md:w-1/2 -mt-0 md:-mt-28">
              ...
              <p className="font-medium mt-8">
                Accrete Conicegare offers trusted, comprehensive medical care
                with a focus on accuracy, compassion, and personalized treatment
                for every patient.
              </p>
